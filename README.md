...
> 📸 **[스크린샷 삽입 위치]** — 위 표에 대응하는 각 탭의 실행 화면 캡처 5장
> ```
> docs/screenshots/01_home.png
> docs/screenshots/02_map.png
> docs/screenshots/03_price_analysis.png
> docs/screenshots/04_trend.png
> docs/screenshots/05_search.png
> ```
...
> 🖼️ **[다이어그램 삽입 위치]** — 전체 워크플로우(수집→저장→가공→제공) 및 사용된 OCI 리소스를 도식화한 이미지
> ```
> ![Architecture](docs/architecture.png)
> ```

아래는 다이어그램에 포함할 전체 흐름의 텍스트 개요입니다.
...
├── output/                  # EDA 시각화 결과
├── docs/
│   ├── architecture.png     # 아키텍처 
│   ├── 01_home.png          # 웹 사이트 화면 
│   ├── 02_map.png
